...
const duelSchema = new mongoose.Schema({
    ...
    assignedMapId: { type: String, default: null },
    assignedMapTitle: { type: String, default: null },
    ...
    assignedMapPreviewUrl: { type: String, default: null },
...
const stage2ParticipantSchema = new mongoose.Schema({
    ...
    relicType: { type: String, enum: ['arena_shield', 'global_shield', 'opponent_skip', 'tier_vision', 'map_reroll', 'chaos_shift', null], default: null },
    relicAwardedAt: { type: Date, default: null },
    relicUsedAt: { type: Date, default: null },
    ...
    encounterStatus: { type: String, enum: ['awaiting_admin', 'pending', 'won', 'lost', null], default: null },
    encounterRevealedAt: { type: Date, default: null },
    assignedOpponentId: { type: String, default: null },
